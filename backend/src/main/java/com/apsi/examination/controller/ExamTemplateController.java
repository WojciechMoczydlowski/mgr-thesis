...
public class ExamTemplateController {
    ...
    @PreAuthorize("hasRole('TEACHER')")
    public void updateExamTemplate(@PathVariable("examTemplateId") Long examTemplateId, @RequestBody ExamTemplateRequest request) {
    ...
    @PreAuthorize("hasRole('TEACHER')")
    public void createTaskPool(@PathVariable("examTemplateId") Long examTemplateId, @RequestBody TaskPoolRequest request) {
    ...
    @PreAuthorize("hasRole('TEACHER')")
    public List<ExamPaperDto> getExamPapers(@PathVariable("courseCode") String courseCode, @PathVariable("examTemplateId") Long examTemplateId) {
